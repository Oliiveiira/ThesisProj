...
public class Puzzle3DMultiPlayerManager : NetworkBehaviour
{
    [SerializeField]
    ...
    void Update()
    {
        if (mirrorRightHand && !isPlaced.Value && IsServer)
        {
            ...
            foreach (var puzzlePiece in puzzlePieces)
            {
                ...
                {
                    Puzzle3DPieceMultiPlayer puzzlePieceTransform = puzzlePiece.GetComponent<Puzzle3DPieceMultiPlayer>();
                    puzzlePieceTransform.right3DPiecePosition.Value = puzzlePiece.transform.position;
                    ...
                    //}
                    puzzlePiece.SetPositionAndRotation(sidePlaceHolders[i].position, Quaternion.Euler(sidePlaceHolders[i].rotation.eulerAngles.x, sidePlaceHolders[i].rotation.eulerAngles.y, sidePlaceHolders[i].rotation.eulerAngles.z));
                    i++;
                    isPlaced.Value = true;
                }
            }
        ...
        else if (mirrorLeftHand && !isPlaced.Value && IsServer)
        {
            ...
            foreach (var puzzlePiece in puzzlePieces)
            {
                ...
                if (gameHasStarted.Value)
                {
                    ...
                    //}
                    puzzlePiece.SetPositionAndRotation(new Vector3(sidePlaceHolders[i].position.x, sidePlaceHolders[i].position.y, -sidePlaceHolders[i].position.z), Quaternion.Euler(sidePlaceHolders[i].rotation.eulerAngles.x, sidePlaceHolders[i].rotation.eulerAngles.y, sidePlaceHolders[i].rotation.eulerAngles.z));
                    i++;
                    isPlaced.Value = true;
                }
            }
        ...
        else if (!mirrorRightHand && !mirrorLeftHand && !mirrorNoneHand && !isPlaced.Value && IsServer)
        {
            ...
            foreach (var puzzlePiece in puzzlePieces)
            {
                ...
                if (gameHasStarted.Value)
                {
                    ...
                    puzzlePieceTransform.right3DPiecePosition.Value = puzzlePiece.transform.position;
                    puzzlePiece.SetPositionAndRotation(sidePlaceHolders[i].position, Quaternion.Euler(-90,0,0));
                    Debug.Log(sidePlaceHolders[i].rotation);
                    i++;
                    isPlaced.Value = true;
                }
            }
    ...
    bool AreTransformPositionsEqual()
    {
        ...
        {
            Puzzle3DPieceMultiPlayer piece = pieceTransform.gameObject.GetComponent<Puzzle3DPieceMultiPlayer>();
